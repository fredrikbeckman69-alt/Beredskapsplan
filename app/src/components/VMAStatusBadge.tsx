...
export function VMAStatusBadge() {
    ...
    return (
        <div
            className={`flex items-center whitespace-nowrap shrink-0 px-4 py-2 rounded-full border backdrop-blur-md shadow-lg transition-all ${status === 'online'
        ...
        >
            <Radio className={`w-5 h-5 shrink-0 mr-3 ${status === 'online' ? 'text-emerald-400' : ''}`} />
