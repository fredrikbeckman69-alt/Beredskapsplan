    ...
    <div className="p-4 md:p-8 space-y-8 w-full animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
          <VMAStatusBadge />
          <div className="flex items-center whitespace-nowrap shrink-0 px-5 py-2.5 bg-emerald-500/10 text-emerald-400 rounded-2xl border border-emerald-500/20 backdrop-blur-md shadow-lg shadow-emerald-500/10">
            <CheckCircle2 className="w-5 h-5 shrink-0 mr-2" />
            <span className="text-sm font-semibold tracking-wide">Systemstatus: Normal</span>
          </div>
          <button className="w-full sm:w-auto shrink-0 whitespace-nowrap bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white px-8 py-3 rounded-2xl font-bold shadow-[0_0_30px_rgba(220,38,38,0.4)] transition-all flex items-center justify-center hover:scale-105 active:scale-95">
